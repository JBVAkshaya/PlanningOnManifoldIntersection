...
##### Debug no collision ######
    ...
    def task_space_run(self, data):
        ...
        while (i< self.n_samples):
            ...
            status, conf_q_new, _, time_taken = self.robots.get_projection_nkz(self.G.V[q_near_id].conf_value, conf_q_target, self.proj_eps, self.proj_max_iter, factor = self.step_factor)
