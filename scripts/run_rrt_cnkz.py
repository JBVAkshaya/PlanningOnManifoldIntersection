...
from algorithms.rrt_cnkz import RRTStarManifold as rrt
import numpy as np
...
argParser.add_argument("-i", "--import_module", help="experiment config file", default= "T_config")

args = argParser.parse_args()

config = importlib.import_module(".".join(["experiment_configs",args.import_module]))

file_names = glob('results/maps/*.json')
file_names = [file_names[-1]]
output_folder = f'results/RAL/cNKZ/{config.struct_type}_{config.num_robots}'
